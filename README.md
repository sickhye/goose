...
[![Build Status](https://drone.io/github.com/sickhye/goose/status.png)](https://drone.io/github.com/sickhye/goose/latest)

# Install

    $ go get github.com/sickhye/goose/cmd/goose

This will install the `goose` binary to your `$GOPATH/bin` directory.

You can also build goose into your own applications by importing `github.com/sickhye/goose/lib/goose`. Documentation is available at [godoc.org](http://godoc.org/github.com/sickhye/goose/lib/goose).
...
import _ "github.com/sickhye/goose/cmd/goose"
```
